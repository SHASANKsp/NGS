...
#######################################################
#1 loading > merging > SCTransform > PrepSCTFindMarkers
...
###############################################################
#2 Loading > merging > SplitObject > lapply SCTransform > merge
...
###############################################################
#3 loading > SCTransform > merging > PrepSCTFindMarkers 
